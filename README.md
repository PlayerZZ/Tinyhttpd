...
A mirror for tinyhttpd(Tinyhttpd非官方镜像,Fork自[sourceForge](https://sourceforge.net/projects/tiny-httpd/),仅供学习)<br>  
...
<p><br>
        ...
        姑且把它弄到VS上了,我的ubuntu虚拟机不知道怎么的，好像阻塞了。CGI还没有弄，准备下一个开源项目吧……
